"""Ivory Coast — Min. Mines Pétrole CI  Currency: XOF"""
import re, sys
from pathlib import Path
from datetime import date
sys.path.insert(0, str(Path(__file__).parent.parent))
from utils.smart_scraper import SmartScraper, CYCLE_MONTHLY_ANY, CYCLE_MONTHLY_1, CYCLE_VARIABLE, CYCLE_STABLE
from utils.base import NoDataError

MONTHS_FR = {"janvier":"01","février":"02","mars":"03","avril":"04","mai":"05","juin":"06",
    "juillet":"07","août":"08","septembre":"09","octobre":"10","novembre":"11","décembre":"12"}

class IvoryCoastScraper(SmartScraper):
    COUNTRY_META = {
        "country":"Ivory Coast","iso2":"CI","region":"West Africa","currency":"XOF",
        "update_cycle":CYCLE_MONTHLY_1,"price_range":(400,1200),
        "official_sources":[
            {"url":"https://www.petroci.ci/","name":"Min. Mines Pétrole CI","confidence":"high"},
            {"url":"https://www.energie.gouv.ci/","name":"Min. Mines Pétrole CI (fallback)","confidence":"high"},
        ],
        "search_queries":[
            "Ivory Coast prix carburant FCFA XOF litre {month} {year} officiel arrêté",
            "Ivory Coast fuel price XOF FCFA {year} official decree",
        ],
        "last_known":{"gas_loc":820,"die_loc":675,"date":"2026-02-01"},
    }
...
def scrape(): return IvoryCoastScraper().run()
if __name__=="__main__":
    r=scrape(); print(f"Ivory Coast: gas={r.gas_loc} XOF | die={r.die_loc} XOF | {r.effective_date}")
