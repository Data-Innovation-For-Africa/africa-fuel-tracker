"""Gabon — Min. Pétrole Gaz ANAC Gabon  Currency: XAF"""
import re, sys
...
class GabonScraper(SmartScraper):
    COUNTRY_META = {
        "country":"Gabon","iso2":"GA","region":"Central Africa","currency":"XAF",
        "update_cycle":CYCLE_QUARTERLY,"price_range":(400,1000),
        "official_sources":[
            {"url":"https://www.hydrocarbures.gouv.ga/","name":"Min. Pétrole Gaz ANAC Gabon","confidence":"high"},
            {"url":"https://www.hydrocarbures.gouv.ga/prix/","name":"Min. Pétrole Gaz ANAC Gabon alt","confidence":"high"},
        ],
        "search_queries":[
            "Gabon prix carburant FCFA XAF litre {month} {year} officiel",
            "Gabon fuel price XAF FCFA {year} official",
        ],
        "last_known":{"gas_loc":644,"die_loc":576,"date":"2026-01-01"},
    }
...
def scrape(): return GabonScraper().run()
if __name__=="__main__":
    r=scrape(); print(f"Gabon: gas={r.gas_loc} XAF | die={r.die_loc} XAF | {r.effective_date}")
